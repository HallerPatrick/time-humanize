...
mod duration {
    ...
    duration_test! {
        ...
        // minus_1s: Duration::from_secs(-1), "now", "1 second",
        plus_5s: Duration::from_secs(5), "now", "5 seconds",
        // minus_5s: Duration::from_secs(-5), "now", "5 seconds",
        plus_15s: Duration::from_secs(15), "15 seconds", "15 seconds",
        // minus_15s: Duration::from_secs(-15), "15 seconds", "15 seconds",
        plus_95s: Duration::from_secs(95), "2 minutes", "1 minute and 35 seconds",
        // minus_95s: Duration::from_secs(-95), "2 minutes", "1 minute and 35 seconds",
        plus_125s: Duration::from_secs(125), "2 minutes", "2 minutes and 5 seconds",
        // minus_125s: Duration::from_secs(-125), "2 minutes", "2 minutes and 5 seconds",
        plus_31m: Duration::from_secs(60 * 31), "31 minutes", "31 minutes",
        // minus_31m: Duration::from_secs(60 * -31), "31 minutes", "31 minutes",
        plus_45m: Duration::from_secs(60 * 45), "45 minutes", "45 minutes",
        // minus_45m: Duration::from_secs(60 * -45), "45 minutes", "45 minutes",
        plus_46m: Duration::from_secs(60 * 46), "an hour", "46 minutes",
        // minus_46m: Duration::from_secs(60 * -46), "an hour", "46 minutes",
